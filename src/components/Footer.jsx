const Footer = () => {
  return (
    <footer className="bg-Dark-Blue ">
      <div className="max-w-[1150px] mx-auto py-10 lg:py-20 px-4">
        <div className="flex flex-col lg:flex-row justify-between gap-6">
          {/* <p className="text-Grayish-Blue lg:hidden text-center">
            &copy; Easybank. All rights reserved.
          </p> */}
          <div className="flex flex-col lg:flex-col items-center lg:justify-between gap-10">
            <div>
            ...
            <div className="flex items-center gap-6 lg:gap-3">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                <path
                  className="fill-white hover:fill-Lime-Green cursor-pointer"
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-20 lg:max-w-[19rem] mx-auto">
            {/* second column */}
            <ul className="flex flex-col gap-6 lg:items-start items-center">
              <li>
                <a
                  href=""
                  className="text-Very-Light-Gray font-medium hover:text-Lime-Green"
                >
                  About Us
                </a>
              </li>
          ...
          {/* fourth column */}
          <div className="flex flex-col lg:items-end max-w-[30rem] mx-auto lg:mx-0">
            <a
              href="#"
            ...
            <p className="text-Grayish-Blue mt-8">
              &copy; Easybank. All rights reserved.
            </p>
          </div>
        </div>
